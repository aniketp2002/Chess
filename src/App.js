...
function App() {
  ...
  let initialPosition = [
    ...
    "B_Pon", "B_Pon", "B_Pon", "", "B_Pon", "B_Pon", "B_Pon", "B_Pon",
    "", "", "", "", "", "", "", "",
    "", "", "", "", "", "", "", "",
    "", "", "", "", "", "", "", "",
    "", "", "", "", "", "", "", "",
    "W_Pon", "W_Pon", "W_Pon", "W_Queen", "W_Pon", "W_Pon", "W_Pon", "W_Pon",
    "W_Rook", "W_Knight", "W_Bishop", "W_King", "", "W_Bishop", "W_Knight", "W_Rook"
  ];
  ...
  const onclk = (unit, i) => {
    ...
    console.log(onclk_checkrun(temp_clickable,i));
